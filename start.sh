...
OUTPUT_URL=${OUTPUT_URL:-"rtmp://ssh101.bozztv.com:1935/ssh101 :1935/ssh101/estacionmixtv"}
...
-c:v libx264 -preset veryfast -b:v 1000k -maxrate 2000k -bufsize 4M -s 1280x720 -r 30 -pix_fmt yuv420p \
